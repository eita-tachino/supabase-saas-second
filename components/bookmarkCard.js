...
export default function BookmarkCard({ bookmark }) {
  ...
  return (
    <div
      style={{ width: "600px" }}
      className="border border-gray-200 rounded-md m-3 p-4 shadow-md bg-white hover:shadow-xl"
    >
      ...
      <div>{synopsis}</div>
      <div className="py-2 my-3 flex">
        <span
          className="cursor-pointer inline mx-1 text-white font-bold py-2 px-4 rounded"
...
function Message() {
  return (
    <div className="z-50 fixed flex p-3 bg-blue-200 rounded-md border-2 border-blue-600 font-bold opacity-90">
      <div className="mr-2">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
